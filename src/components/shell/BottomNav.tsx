...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Navegacao principal" className="fixed bottom-0 left-0 right-0 z-30 bg-bg/90 backdrop-blur-md border-t border-border">
      <div className="flex items-center justify-around max-w-lg mx-auto h-14" role="menubar">
